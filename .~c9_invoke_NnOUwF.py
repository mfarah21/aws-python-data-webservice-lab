...
AwsPythonAppStack(app, rootstackname+"app", vpc=vpc_stack.vpc, rds=rds_stack.cluster_arn, secret_arn = rds_stack.secret_arn, clientsecuritygroup = rds_stack.rdsclient_securitygroup)
